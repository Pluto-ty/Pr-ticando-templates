...
<br>
<p>
O desafio é criar um layout de para um anúncio com captação de emails. Utilizando Html, Css, e Javascript.
</p>
...
-  Veja Funcionand: [Abrir Página](https://thyagoaraujom.github.io/Praticando-templates/iniciante/ping-coming-soon-page-master/index.html)

-  Origem do Template: [Origem do Template](https://www.frontendmentor.io/challenges/ping-single-column-coming-soon-page-5cadd051fec04111f7b848da)
...
-  Html
-  Css ( Grid e BEM)
-  Javascript ( Função para avisar que o campo de email está incorreto.)

<h3 id="o-que-aprendi" align="center"> O que usei e aprendi: </h3>
<br>
<p>
Neste desafio utilizei grid layout para fazer a base do projeto. Junto com flex-box para alinhar e javascript para colocar a menssagem de aviso caso o usuário coloque o email de forma incorreta.
</p>

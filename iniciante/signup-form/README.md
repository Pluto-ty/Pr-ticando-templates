...
<br>
<p>
O desafio é criar um layout de login de usuário simples. Utilizando Html, Css, e Javascript.
</p>
...
-  Veja Funcionand: [Abrir Página](https://thyagoaraujom.github.io/Praticando-templates/iniciante/intro-component-with-signup-form-master/index.html)
...
-  Html
-  Css ( Grid e BEM)
-  Javascript ( Função para avisar se os campos estão com algum tipo de informação errada.)

<h3 id="o-que-aprendi" align="center"> O que usei e aprendi: </h3>
<br>
<p>
Neste desafio utilizei grid layout para fazer a base do projeto. Junto com flex-box para alinhar e javascript para colocar as menssagens de aviso caso o usuário digite algo errado dentro dos campos.
</p>

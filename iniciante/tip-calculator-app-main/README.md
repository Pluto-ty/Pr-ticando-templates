...
<br>
<p>
O desafio é criar um layout para calcular quanto cada pessoa deveria pagar de gorjeta baseado no valor, a porcentagem de gorjeta e quantas pessoas para pagar. Deixando o mais próximo do design possível. Os usuários devem conseguir ver o layout, independente do tamanho da tela ou dispositivo.
</p>
...
-  Veja Funcionand: [Abrir Página](https://thyagoaraujom.github.io/Praticando-templates/iniciante/four-card-feature-section-mastertip-calculator-app-main/index.html)

-  Origem do Template: [Origem do Template](https://www.frontendmentor.io/challenges/tip-calculator-app-ugJNGbJUX)
...
-  Html
-  Css ( Grid e BEM)
-  Javascript ( Função para aparecer as respostas.)

<h3 id="o-que-aprendi" align="center"> O que usei e aprendi: </h3>
<br>
<p>
Neste desafio utilizei grid layout para fazer a quase todo o projeto, com uso de flexbox para alinhar os elementos. Utilizei o javascript para fazer toda a função do calculo, verificação dos valores e aviso para valores errados.
</p>
